...
// })
// console.log('HUMAN results :', humanResults.map(r => {
//   const isItHuman = r.human > 0.20454825460910797
//   return 'humanyness:' + isItHuman + '   : ' + r.human
// }))
...
//   return trainedNetwork.run(mash)
// })
// console.log('BOT results :', botResults.map(r => {
//   const isItHuman = r.human > 0.20454825460910797
//   return 'humanyness:' + isItHuman + '   : ' + r.human
// }))
